...
import com.skalicky.cryptobot.exchange.kraken.connector.api.dto.KrakenClosedOrderDescriptionDtoBuilder;
...
public class KrakenMapEntryToClosedOrderBoConverterUTest {
    ...
    @Test
    public void test_convert_when_allDataProvider_then_successfulConversion() {
        final BigDecimal desiredPrice = new BigDecimal("5762.3");
        final KrakenClosedOrderDescriptionDto descriptionDto = KrakenClosedOrderDescriptionDtoBuilder
                .aKrakenClosedOrderDescriptionDto()
                .withType("buy")
                .withOrdertype("limit")
                .withPair("XBTEUR")
