...
public class KrakenClosedOrderDto {
    ...
    @Nullable
    private KrakenClosedOrderDescriptionDto descr;
    @Nullable
    ...
    @Nullable
    public KrakenClosedOrderDescriptionDto getDescr() {
        return descr;
    }

    public void setDescr(@Nullable final KrakenClosedOrderDescriptionDto descr) {
        this.descr = descr;
    }
